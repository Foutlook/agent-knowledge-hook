...
```powershell
node C:\workspace\agent-knowledge-hook\agent-knowledge\bin\agent-knowledge.js record-fix --type bug --title "<纠错标题>" --knowledge-root C:\workspace\team-agent-knowledge
```
