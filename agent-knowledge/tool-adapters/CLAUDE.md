...
```powershell
node <workspace-root>\agent-knowledge-hook\agent-knowledge\bin\agent-knowledge.js record-fix --type bug --title "<纠错标题>" --knowledge-root <workspace-root>\team-agent-knowledge
```
